...
// })
  ...
  return (
  <div className="max-w-[1000px] m-auto p-3 justify-center w-full h-full"> 
    ...
    {/* <div className="float-left w-[15%] h-[10%] mt-[40%]">
      ...
      <div className="rounded-md flex justify-center mx-auto bg-no-repeat bg-contain bg-center custom-img relative h-[93vh] w-[60%]">
        <div className="rounded-md bg-[#000]/50 mb-[12.5%] p-3 text-white mt-3">
        ...
        <div className='rounded-md bg-[#000]/60 mt-10 px-4 -mx-3 text-center justify-center m-auto' style={{}}>
        ...
        <div className='absolute bottom-0 bg-[#000]/60 w-full overflow-hidden h-[5%] flex py-1 justify-evenly mb-3'>
